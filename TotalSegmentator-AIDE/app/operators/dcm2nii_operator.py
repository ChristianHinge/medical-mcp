...
class Dcm2NiiOperator(Operator):
    ...
    def __init__(self,fragment, *arg, output_folder,**kwargs):
        ...
        super().__init__(fragment,*arg,**kwargs)
    ...
    def setup(self,spec:OperatorSpec):
        #spec.output('dcm_input')
        spec.output('nii_ct_dataset')
        spec.input('image')
    ...
    def compute(self, op_input: InputContext, op_output: OutputContext, context: ExecutionContext):
        ...
        # assert 1==2
        # study_selected_series = op_input.receive("study_selected_series_list")[0]  # nb: load single DICOM series from Study
