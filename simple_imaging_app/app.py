...
class App(Application):
    ...
    def compose(self):
        ...
        selector = DICOMSeriesSelectorOperator(self,rules=Rules_Text, all_matched=True,name="selector")
        to_volume = DICOMSeriesToVolumeOperator(self,name="to_volume")
        ...
        self.add_flow(to_volume, median_op, {("image", "in1")})
